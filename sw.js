// ChocolatePy Service Worker v2.0
// Enables offline support, caching, and PWA/Chromebook app installation

const CACHE_NAME = 'chocolatepy-v2.0';
const RUNTIME_CACHE = 'chocolatepy-runtime-v2.0';
...
console.log('[SW] ChocolatePy Service Worker v2.0 loaded');
